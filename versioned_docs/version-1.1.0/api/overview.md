...
- [Authentication](/docs/next/api/authentication) - Login and signup
- [Machines](/docs/next/api/machines) - Machine management
- [Sessions](/docs/next/api/sessions) - Terminal sessions and dashboard
- [Users](/docs/next/api/users) - Profile management
