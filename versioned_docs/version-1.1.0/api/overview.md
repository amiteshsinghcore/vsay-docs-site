...
- **vsay-auth** — authentication, user management, groups, roles, admin, and audit; proxies all other requests to the machine backend
- **vsay-machine-backend** — machines, terminals, sessions, dashboard, profile, and community
...
### Audit (Protected — vsay-auth, company_admin+)
| Method | Endpoint | Description |
|:-------|:---------|:------------|
...
- [Authentication](/docs/1.1.0/api/authentication) — Login, signup, OTP, tenant selection
- [Machines](/docs/1.1.0/api/machines) — Machine management and access control
- [Sessions](/docs/1.1.0/api/sessions) — Terminal sessions and dashboard
- [Profile](/docs/1.1.0/api/users) — User profile and API keys
