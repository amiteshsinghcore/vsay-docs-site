...
The Community page is the built-in issue tracker for your team — create tickets, post solutions, and track infrastructure problems collaboratively. [Learn more →](/docs/next/features/community)
